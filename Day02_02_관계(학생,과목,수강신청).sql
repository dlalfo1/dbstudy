...
CREATE TABLE ENROLL_TBL (
    ...
    CONSTRAINT FK_ENROLL_STUDENT FOREIGN KEY(STU_NO) REFERENCES STUDENT_TBL(STU_NO) ON DELETE CASCADE, -- FK 제약조건이 NOT NULL로서 NULL값으로 둘 수 없으니 PK가 지워졌을씨 FK도 다 지워버리는 것.
