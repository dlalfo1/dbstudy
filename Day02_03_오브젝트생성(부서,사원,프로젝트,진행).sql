...
CREATE TABLE EMPLOYEE_TBL(
    ...
    CONSTRAINT FK_EMP_DEPT FOREIGN KEY(DEPT_NO) REFERENCES DEPARTMENT_TBL(DEPT_NO) ON DELETE SET NULL -- 부서가 없어지면 사원의 부서정보만 NULL 처리 된다.
                                                                                                      -- 중요! PK의 제약조건을 따라가는 것이 아니라 FK의 제약조건을 따라가는 것이다. 
);    
